...
!**s/r Bermejo_Conde - Ensures conservation of interpolated field (Bermejo and Conde,2002)
      ...
      subroutine Bermejo_Conde_hlt ( F_bc, F_ntr_bc, F_i0, F_in, F_j0, F_jn, F_k0 )
...
!      call gtmg_start (74, 'BermejoC', 38)
      ...
      !-------------------------------------------------------------------------------------------------
      call mass_tr_PM_hlt ( mass_p_8, mass_m_8, mass_fo_8, mass_fi_8, F_bc, airm1, airm0, &
...
!         call gtmg_stop  (16)
      ...
      !--------------------------------------------------------------------------
      call mass_tr_X_hlt (mass_wei_8,F_bc,air_mass_m,l_minx,l_maxx,l_miny,l_maxy,l_nk,F_i0,F_in,F_j0,F_jn,F_k0,F_ntr_bc,1)
...
!      call gtmg_start (17, 'MINMAX', 74)
      ...
      if (Adz_BC_min_max_L) then
         ...
         !--------------------------------------------------------------------------
         call mass_tr_X_hlt (mass_bc_r_8,F_bc,air_mass_m,l_minx,l_maxx,l_miny,l_maxy,l_nk,F_i0,F_in,F_j0,F_jn,F_k0,F_ntr_bc,2)
...
!      call gtmg_stop  (17)
      ...
      if (reset_epsilon_L.or.Adz_verbose>0) then
         ...
         !Evaluate Mass of Tracer for all tracers using Bermejo-Conde (Component %m)
         !--------------------------------------------------------------------------
         call mass_tr_X_hlt (mass_bc_8,F_bc,air_mass_m,l_minx,l_maxx,l_miny,l_maxy,l_nk,F_i0,F_in,F_j0,F_jn,F_k0,F_ntr_bc,2)
...
!
 ...
 1005 format(1X,A9,A3,A25,E19.12,A3,E19.12)
      ...
      end subroutine Bermejo_Conde_hlt
