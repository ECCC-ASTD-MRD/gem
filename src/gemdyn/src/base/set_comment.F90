...
!**s/p set_usrdir - initialization of common block
      ...
      integer function set_comment (F_argc,F_argv_S,F_cmdtyp_S,F_v1,F_v2)
      use lun
      implicit none
...
!object
!	This function is
!       called when the keyword "comment" is found in the first word
...
!
! examples:
! comment('This is a comment in the outcfg.out file')
! comment("Andre's comment")
!-------------------------------------------------------------------
