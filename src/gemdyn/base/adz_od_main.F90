...
!---------------------------------- LICENCE END ---------------------------------
      ...
      subroutine adz_od_main ( orhsu, rhsu, orhsv, rhsv, orhsc ,&
...
!
      ...
      call adz_od_traject (pw_uu_plus, pw_vv_plus, zdt1, &
                           ut0       ,    vt0    , zdt0, &
      ...
      call adz_od_tricub ( Adz_stack,1,Adz_pmu,Adz_cpntr_q,Adz_num_u,&
              Adz_expu,Adz_i0u,Adz_inu,Adz_j0,Adz_jn,Adz_k0,sto_phy_L)

      Adz_stack(1)%src => orhsv
      Adz_stack(1)%dst =>  rhsv
      call adz_od_tricub ( Adz_stack,1,Adz_pmv,Adz_cpntr_q,Adz_num_v,&
              Adz_expv,Adz_i0,Adz_in,Adz_j0v,Adz_jnv,Adz_k0,sto_phy_L)

      Adz_stack(1)%src => orhsc
      Adz_stack(1)%dst =>  rhsc
      call adz_od_tricub (Adz_stack,1,Adz_pm ,Adz_cpntr_q,Adz_num_q,&
              Adz_expq, Adz_i0,Adz_in,Adz_j0,Adz_jn,Adz_k0,sto_phy_L)
      ...
      call adz_od_tricub ( Adz_stack,n,Adz_pt ,Adz_cpntr_t,Adz_num_t,&
               Adz_expt,Adz_i0,Adz_in,Adz_j0,Adz_jn,Adz_k0t,sto_phy_L)
