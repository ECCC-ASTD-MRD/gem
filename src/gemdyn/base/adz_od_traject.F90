...
!---------------------------------- LICENCE END ---------------------------------
      ...
      subroutine adz_od_traject (uut1, vvt1, zzt1, &
                                 uut0, vvt0, zzt0, &
...
#include <arch_specific.hf>
      ...
      integer :: iter,i,j,k,kk1,nb,np,i0,in,j0,jn
...
!
      ...
      call adz_od_prepareWinds (uut1, vvt1, zzt1, &
                                uut0, vvt0, zzt0, &
                            Minx,Maxx,Miny,Maxy,NK)
         
      ITER_TRAJ: do iter = 1, Adz_niter

         call adz_od_request (Adz_expq, i0,in,j0,jn, Adz_k0m,l_nk    ,&
                           Adz_wpxyz(-1,-1,1,1), Adz_wpxyz(-1,-1,1,2),&
                           Adz_wpxyz(-1,-1,1,3), l_ni,l_nj,l_nk)

         call tricublin_zyx3_n ( Adz_uvw_dep,Adz_uvw_d(1,1,1,1), &
                                 Adz_pxyzm,Adz_cpntr_q,np )
         call adz_od_cortraj ()
...
!!DIR$ IVDEP
      ...
      call adz_od_request (Adz_expq,Adz_i0,Adz_in,Adz_j0,Adz_jn     ,&
                           Adz_k0,l_nk,Adz_wpxyz(-1,-1,1,1)         ,&
                           Adz_wpxyz(-1,-1,1,2),Adz_wpxyz(-1,-1,1,3),&
                           l_ni,l_nj,l_nk)
      call adz_od_count (Adz_expq)
