...
!!!#include <arch_specific.hf>
   ...
   !/@*
   subroutine handle_error1_L(F_isOK_L,F_FromSubName,F_Message)
      implicit none
!!!#include <arch_specific.hf>
      !@objective 
      !@arguments
      logical,intent(in) :: F_isOK_L
      character(len=*),intent(in) :: F_FromSubName
      ...
      call handle_error1(errcode,F_FromSubName,F_Message)
      !---------------------------------------------------------------------
      return
   end subroutine handle_error1_L


   !/@*
   subroutine handle_error1(F_errorCode,F_FromSubName,F_Message)
      use iso_c_binding
      use rpn_comm_itf_mod
...
subroutine handle_error_L(F_isOK_L,F_FromSubName,F_Message)
   use mod_handle_error, only: handle_error1_L
   implicit none
   !@objective 
   !@arguments
   logical,intent(in) :: F_isOK_L
...
!*@/
   !---------------------------------------------------------------------
   call  handle_error1_L(F_isOK_L,F_FromSubName,F_Message)
   !---------------------------------------------------------------------
   return
...
!*@/
   !---------------------------------------------------------------------
   call handle_error1(F_errorCode,F_FromSubName,F_Message)
   !---------------------------------------------------------------------
   return
