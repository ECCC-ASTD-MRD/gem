...
!!if_off
   use chm_utils_mod,           only: chm_lun_out, chm_error_l, chm_msg_debug
...
!
   ...
   call msg_toall(chm_msg_debug, 'mach_plumerise_weight [BEGIN]')
...
!        print *, 'INDEX TOP AND BOTTOM , chm_nk' , index_top , chm_nk
   ...
   call msg_toall(chm_msg_debug, 'mach_plumerise_weight [END]')
