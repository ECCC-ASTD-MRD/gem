...
!============================================================================
      integer function pkg_cam_idxinit(idx)
         ...
         call msg_toall(chm_msg_debug, 'pkg_cam_idxinit [BEGIN]')
         ...
         call msg_toall(chm_msg_debug, 'pkg_cam_idxinit [END]')
...
!        local variable
         ...
         call msg_toall(chm_msg_debug, 'pkg_cam_metainit [BEGIN]')
         ...
         call msg_toall(chm_msg_debug, 'pkg_cam_metainit [END]')
