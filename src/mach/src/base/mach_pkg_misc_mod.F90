...
!============================================================================
      integer function pkg_misc_idxinit(idx)
         ...
         call msg_toall(chm_msg_debug, 'pkg_misc_idxinit [BEGIN]')
...
! KPP solver internal time-step
         ...
         call msg_toall(chm_msg_debug, 'pkg_misc_idxinit [END]')
...
!============================================================================
      subroutine pkg_misc_metainit()
       ...
       implicit none
         ...
         call msg_toall(chm_msg_debug, 'pkg_misc_metainit [BEGIN]')
...
!  Volatile bus variable for SOA formation under canopy
         ...
         if (var_step > 0) then
            ...
            if (chm_canopy_shading_l) then
! Use the dd_pvarid component to store hstart under canopy columns
         ...
         call msg_toall(chm_msg_debug, 'pkg_misc_metainit [END]')
