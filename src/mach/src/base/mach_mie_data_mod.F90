...
!
      call msg_toall(chm_msg_debug, 'mach_mie_optical_properties [BEGIN]')
!
      nang0 = 1
!
...
!  Output
      ...
      call msg_toall(chm_msg_debug, 'mach_mie_optical_properties [END]')
...
!
      call msg_toall(chm_msg_debug, 'mach_mie_lookup [BEGIN]')
!
...
!  Convert total scattering to single scattering albedo:
      ...
      endwhere
!
      call msg_toall(chm_msg_debug, 'mach_mie_lookup [END]')
!
      return
...
!C***********************************************************************
      call msg_toall(chm_msg_debug, 'bhmie [BEGIN]')
!C*** Safety checks
      IF (NANG > MXNANG) THEN
...
!C
      ...
      call msg_toall(chm_msg_debug, 'bhmie [END]')
      RETURN
