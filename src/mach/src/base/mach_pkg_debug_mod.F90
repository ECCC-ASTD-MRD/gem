...
module mach_pkg_debug_mod
   use chm_utils_mod,        only: NOMV_LEN, LONG_VARNAME, DICTSTRING_LEN, &
                                   MAX_DEBUG_VAR, pre_increment, chm_msg_debug
...
!============================================================================
      integer function pkg_debug_idxinit(idx, chm_debug_2d_i, chm_debug_3d_i)
         ...
         call msg_toall(chm_msg_debug, 'pkg_debug_idxinit [BEGIN]')
         ...
         call msg_toall(chm_msg_debug, 'pkg_debug_idxinit [END]')
...
!============================================================================
      subroutine pkg_debug_metainit(chm_debug_2d_i, chm_debug_3d_i)
         ...
         call msg_toall(chm_msg_debug, 'pkg_debug_metainit [BEGIN]')
         ...
         call msg_toall(chm_msg_debug, 'pkg_debug_metainit [END]')
