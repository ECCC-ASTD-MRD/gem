...
module chm_nml_mod
   ...
   character(len=NMLKEY_LEN) chm_fctr_adj_s        ! Switch for rain-out adjustment (Default = 'NIL')
   ...
   logical(kind=4) chm_seaflux_sst_l                 ! Enable sea-surface temperature modulation of sea-salt flux? (Default = .true.)
   ...
   namelist /chemistry_cfgs/ chm_master,            chm_model_s,            chm_pkg_pm_s,       chm_pkg_gas_s,     &
                             ...
                             chm_pblh_min_l,        chm_ae_spread_l,        chm_nosurfzoneflux_l, chm_fctr_adj_s,  &
                             chm_seaflux_sst_l
