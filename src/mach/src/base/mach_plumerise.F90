...
!!if_off
   ...
   use chm_utils_mod,           only: chm_lun_out, ik, chm_error_l, &
...
!
   ...
   zrig(1:chm_ni, 1:chm_nk)    => pvars(rig)%data
   zshear2(1:chm_ni, 1:chm_nk) => pvars(shear2)%data
!
