...
!!if_off
   use chm_utils_mod,       only: chm_lun_out, ik, chm_error_l, chm_msg_debug
...
!
   ...
   call msg_toall(chm_msg_debug, 'mach_landuse [BEGIN]')
!
!  do j = 1, 26
!     do i = 1, chm_ni
...
! Look if the summation of the 15 landuse_out types equal 1.
   ...
   call msg_toall(chm_msg_debug, 'mach_landuse [END]')
   return
