...
subroutine tropo_xcol( x_vmr, hu_vmr, p_low, p_up, x_over, ni,nkm1)
   ...
   use linoz_param, only: avno, mwt_air, local_dbg, hu_linoz_tropo
...
!!!#include <arch_specific.hf>
   ...
   real, intent(in)    :: hu_vmr(ni, nkm1)           ! ppmv vmr
   ...
   do i = 1, ni
      ...
      do k = 1, nkm1
         ...
         ! Tropospheric column below humidity level of 10 ppmv
         if (hu_vmr(i,k) >= hu_linoz_tropo) then
   ...
   !----------------------------------------------------------------
   return
end subroutine tropo_xcol

!#TODO: this code is identical to ghg_xcol apart from the condition on hu_vmr... we should merge them
!#TODO: almost identical to linoz_xcol as well but condition and constant value
