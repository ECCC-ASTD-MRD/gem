...
! Outc_usrdir        | Outc_usrdir(i) contains the index that indicates|
!                    | the Usrdir set to use for Outc_var(*,j)         |
!----------------------------------------------------------------------
!
   ...
   integer, dimension(MAXSET), target :: Outc_lev,Outc_grid,Outc_step,Outc_usrdir
