...
module mach_pkg_diag_mod
   use chm_utils_mod,        only: pre_increment, chm_msg_debug
...
!============================================================================
      integer function pkg_diag_wet_idxinit(idx)
         ...
         call msg_toall(chm_msg_debug, 'pkg_diag_wet_idxinit [BEGIN]')
...
! Note only these need to be incremented, other are already incremented in other module packages.
         ...
         call msg_toall(chm_msg_debug, 'pkg_diag_wet_idxinit [END]')
...
!============================================================================
      integer function pkg_diag_col_idxinit(idx)
         ...
         call msg_toall(chm_msg_debug, 'pkg_diag_col_idxinit [BEGIN]')
...
!
         ...
         call msg_toall(chm_msg_debug, 'pkg_diag_col_idxinit [END]')
...
!============================================================================
      integer function pkg_diag_pm_idxinit(idx)
         ...
         call msg_toall(chm_msg_debug, 'pkg_diag_pm_idxinit [BEGIN]')
         ...
         call msg_toall(chm_msg_debug, 'pkg_diag_pm_idxinit [END]')
...
!
      subroutine pkg_diag_col_metainit()
         ...
         call msg_toall(chm_msg_debug, 'pkg_diag_col_metainit [BEGIN]')
!
! 3D
...
! 2D end
         call msg_toall(chm_msg_debug, 'pkg_diag_col_metainit [END]')
...
!
      subroutine pkg_diag_acc_metainit()
         implicit none
!
         call msg_toall(chm_msg_debug, 'pkg_diag_acc_metainit [BEGIN]')
!
! 3D Accumulators (gas)
!
...
!
         ...
         call msg_toall(chm_msg_debug, 'pkg_diag_acc_metainit [END]')
...
!
         call msg_toall(chm_msg_debug, 'pkg_diag_dry_metainit [BEGIN]')
!
...
! Aerosol species dry deposition
         ...
         call msg_toall(chm_msg_debug, 'pkg_diag_dry_metainit [END]')
...
!
      subroutine pkg_diag_wet_metainit()
         ...
         call msg_toall(chm_msg_debug, 'pkg_diag_wet_metainit [BEGIN]')
...
! wet deposition
         ...
         call msg_toall(chm_msg_debug, 'pkg_diag_wet_metainit [END]')
...
!
      subroutine pkg_diag_pm_metainit()
         ...
         call msg_toall(chm_msg_debug, 'pkg_diag_pm_metainit [BEGIN]')
         ...
         call msg_toall(chm_msg_debug, 'pkg_diag_pm_metainit [END]')
