...
MODULE mach_pkg_messy_mod
  ...
  use chm_utils_mod,      only: pre_increment, sp, dp, i4, chm_lun_out, &
                                chm_stop, chm_msg_debug
...
!============================================================================
  subroutine pkg_messy_idxinit()
   ...
   call msg_toall(chm_msg_debug, 'pkg_messy_idxinit [BEGIN]')
...
! assign name
   ...
   call msg_toall(chm_msg_debug, 'pkg_messy_idxinit [END]')
...
! ****************************************************************************
  subroutine jval_solar_time_control(cdisse, val)
    ...
    call msg_toall(chm_msg_debug, 'jval_solar_time_control [BEGIN]')
...
!
    ...
    call msg_toall(chm_msg_debug, 'jval_solar_time_control [END]')
