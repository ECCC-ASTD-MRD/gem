...
#define SFCVAR(MYVAR,MYNAME) type(SFCVAR_T) :: MYVAR = SFCVAR_T(-1,-1,0,0,0,0,.false.,MYNAME)
   ...
   type :: SFCVARLIST_T
      ...
      SFCVAR(agingcoef, 'agingcoef')
      SFCVAR(agingcoefen, 'agingcoefen')
      ...
      SFCVAR(azim, 'azim')
      SFCVAR(betagr, 'betagr')
      SFCVAR(betavg, 'betavg')
      SFCVAR(bcoef, 'bcoef')
      SFCVAR(bld, 'bld')
      SFCVAR(blden, 'blden')
      ...
      SFCVAR(drpsnc, 'drpsnc')
      SFCVAR(drpsncaf, 'drpsncaf')      
      SFCVAR(dsst, 'dsst')
      ...
      SFCVAR(fdss, 'fdss')
      SFCVAR(fl, 'fl')
      SFCVAR(flcond, 'flcond')
      SFCVAR(flusolis, 'flusolis')
      SFCVAR(fluslop, 'fluslop')
      SFCVAR(fq, 'fq')
      SFCVAR(frootd, 'frootd')
      SFCVAR(frootdyn, 'frootdyn')
      SFCVAR(frv, 'frv')
      SFCVAR(frzdepth, 'frzdepth')
      SFCVAR(frzthick, 'frzthick')
      SFCVAR(fsd, 'fsd')
      SFCVAR(fsf, 'fsf')
      SFCVAR(ftemp, 'ftemp')
      SFCVAR(fv, 'fv')
      ...
      SFCVAR(hrsurfgr, 'hrsurfgr')
      SFCVAR(hst, 'hst')
      SFCVAR(husurf, 'husurf')
      SFCVAR(husurffl, 'husurffl')
      ...
      SFCVAR(intsnc, 'intsnc')
      SFCVAR(intsncaf, 'intsncaf')
      SFCVAR(isoil, 'isoil')
      SFCVAR(kcl, 'kcl')
      SFCVAR(khc, 'khc')
      SFCVAR(km, 'km')
      SFCVAR(ksat, 'ksat')
      SFCVAR(ksatnat, 'ksatnat')
      SFCVAR(ksatc, 'ksatc')
      SFCVAR(ksatnatc, 'ksatnatc')
      SFCVAR(kt, 'kt')
      SFCVAR(lai, 'lai')
      ...
      SFCVAR(sroad_wstok, 'sroad_wstok')
 !     SFCVAR(sroad_wstoken, 'sroad_wstoken')
      SFCVAR(sroof_alb, 'sroof_alb')
      SFCVAR(sroof_alben, 'sroof_alben')
      SFCVAR(sroof_depth, 'sroof_depth')
      SFCVAR(sroof_emis, 'sroof_emis')
      SFCVAR(sroof_emisen, 'sroof_emisen')
      SFCVAR(sroof_psn, 'sroof_psn')
      ...
      SFCVAR(sroof_wstok, 'sroof_wstok')
 !     SFCVAR(sroof_wstoken, 'sroof_wstoken')
      SFCVAR(stown_melt, 'stown_melt')
      SFCVAR(stomr, 'stomr')
      ...
      SFCVAR(unlsnc, 'unlsnc')
      SFCVAR(unlsncaf, 'unlsncaf')
      SFCVAR(urban, 'urban')
      SFCVAR(vca, 'vca')
      ...
      SFCVAR(grkmod_a, 'grkmod_a')
      SFCVAR(grkmod_aen, 'grkmod_aen')
      SFCVAR(kasmod_a, 'kasmod_a')
      SFCVAR(kasmod_aen, 'kasmod_aen')
           ! needed to adjust the multiplying coefficients by 
           ! the fraction of land covered with agricultural area:
      SFCVAR(agrifrac, 'agrifrac')
