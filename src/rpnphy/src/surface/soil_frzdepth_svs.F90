...
module soil_frzdepth_svs_mod
  implicit none
  public
contains
      SUBROUTINE SOIL_FRZDEPTH_SVS( &
        ISOIL, WRES, WSAT, DL, DZ, FRZDEPTH, FRZTHICK, THWDEPTH, N, NLEVELS)
      ...
      REAL, DIMENSION(N, NLEVELS) :: ISOIL, WRES, WSAT
      ...
      ! WRES     residual unfrozen liquid water content when a soil layer is entirely frozen (from Niu and Yang (2006)) [m3/m3]
      ! WSAT     saturated water liquid content or porosity [m3/m3]
      ! 
      !          - OUTPUT -
      !
      ...
      DO I=1,N
         ...
         DO K=1,NLEVELS
            ...
            !Compute the fraction of frozen liquid water 
            FRZFRAC(I,K) = MAX(0.0,MIN(ISOIL(I,K)/(WSAT(I,K) - WRES(I,K)),1.0))
    ...
    END SUBROUTINE SOIL_FRZDEPTH_SVS
  end module soil_frzdepth_svs_mod
