...
!!      B. Cluzet   02/2018 Adding band indices corresponding to MODIS bands
!--------------------------------------------------------------------------------
...
2220,2240,2260,2280,2300,2320,2340,2360,2380,2400,2420,2440,2460,2480,2500/)
!
! B.Cluzet Indices of MODIS bands (nm) (1: 640, 2: 860, 3: 460, 4: 560, 5: 1240, 6: 1640, 7: 2120) 
INTEGER, PARAMETER ::NPNBANDS_MODIS = 7 ! number of modis bands
INTEGER, DIMENSION(7), PARAMETER ::XPWAVEIND_MODIS  = (/18, 29, 9, 14, 48, 68, 92/) 
!same in meters
...
!REAL, PARAMETER :: XPCOEFNIR_DIR = 0.001000684 !Abandonned because eronneous, 
REAL, PARAMETER :: XPCOEFNIR_DIR = 0.012071417 ! complentary to the sum of XPRATIO_DIR coefs
...
REAL, PARAMETER :: XPCOEFNIR_DIF = 0.0009679 ! complentary to the sum of XPRATIO_DIF coefs
!
...
! As the previous parameterization is probably erronate, replace by the new one.
!
REAL, PARAMETER :: XP_MUDIFF = 0.666666733 ! =cos(48.18968/180.*XPI) : diffuse incident flux is treated as direct flux at incident angle 48.18968 deg
!This is done to accordate direct and diffuse formulation from kokhanovsky 2004
!
...
! Boolean that indicate if the impurity type concerned is treated using it's refractive index or using its mass absobtion efficiency (MAE).
...
REAL,DIMENSION(3), PARAMETER :: XSNOWIMP_DENSITY = (/1270.,2600.,2000./)!Soot density according to Flanner et.al 2012 (set to 1500 in Tuzet et al.2017) and 
!Dust Density (hess1995), not used if MAE parameterization is activated (default behaviour)

INTEGER, PARAMETER :: XSWE_MIN_IMP = 10

LOGICAL, PARAMETER :: L_ICE_TARTES = .FALSE.
