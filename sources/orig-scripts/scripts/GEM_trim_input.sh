...
list_A=$(r.fstliste.sh -izfst $file -typvar "A" |cut -d ":" -f 11 | sort -u )
list_P=$(r.fstliste.sh -izfst $file -typvar "P" |cut -d ":" -f 11 | sort -u )
list_I=$(r.fstliste.sh -izfst $file -typvar "I" |cut -d ":" -f 11 | sort -u )
