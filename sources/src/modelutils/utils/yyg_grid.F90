...
!**s/r yyg_info - Decoding of the g4 parameter that contains the nomvar
...
!
      ...
      integer ngrids
      parameter (ngrids = 100)
      character*12 grid_type(ngrids)
...
!**s/r grid_getll - Obtain positional parameters
...
! v4_50 - Desgagne M.       - initial version
!
      integer  fstprm,fstluk
      external fstprm,fstluk
...
!
      ...
      if ( grid_type(F_gid) .eq. 'YINYANG' ) then
...
!s/r UOG_parpos - Compute Yin-Yang grid positional parameters
!
...
!
      integer NX, NY
      real*8  F_x_8(NX), F_y_8(NY),F_xbeg, F_ybeg, F_xend, F_yend
...
!
      ...
      real*8 F_yinlat1, F_yinlon1, F_yinlat2, F_yinlon2, &
             F_yanlat1, F_yanlon1, F_yanlat2, F_yanlon2
!
!author
...
!     call dgemm('N','N',1,3,3,1._8,xyz1_8,1,invrot_8,1, 0._8,xyz3_8,1)
!     call dgemm('N','N',1,3,3,1._8,xyz2_8,1,invrot_8,1, 0._8,xyz4_8,1)
