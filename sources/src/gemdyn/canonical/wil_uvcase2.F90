...
!**s/r wil_uvcase2 - To setup Williamson Case 2: Steady state nonlinear geostrophic flow (WINDS)

      subroutine wil_uvcase2 (F_u,F_v,F_minx,F_maxx,F_miny,F_maxy,F_nk,F_stag_L)
...
#include <arch_specific.hf>
      ...
      !object
      !================================================================================
      !     To setup Williamson Case 2: Steady state nonlinear geostrophic flow (WINDS)
      ...
      integer i,j,k
      real*8  ubar_8,sina_8,cosa_8,rlon_8,rlat_8,sint_8,cost_8, &
