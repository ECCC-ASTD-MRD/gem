...
!**s/r dcmip_tracers11_transport - Setup for 3D deformation Flow (DCMIP 2012)
      ...
      subroutine dcmip_tracers11_transport (F_u,F_v,F_zd,F_tv,F_q,F_topo,F_s,F_q1,F_q2,F_q3,F_q4, &
         ...
         do j = 1,l_nj
            ...
            if (Ptopo_couleur == 0) then
               ...
               do i = 1,l_ni
                  ...
                  call test1_advection_deformation (lon,lat,p,z,zcoords,Ver_a_8%t(k),Ver_b_8%t(k),Cstv_pref_8,u,v,w,zd,t,tv,phis,ps,rho,q,q1,q2,q3,q4,time)
               ...
               do i = 1,l_ni
                  ...
                  call test1_advection_deformation (lon,lat,p,z,zcoords,Ver_a_8%t(k),Ver_b_8%t(k),Cstv_pref_8,utt_8,vtt_8,w,zd,t,tv,phis,ps,rho,q,q1,q2,q3,q4,time)
         ...
         do j = 1,l_nj
            ...
            if (Ptopo_couleur == 0) then
               ...
               do i = 1,l_ni
                  ...
                  call test1_advection_deformation (lon,lat,p,z,zcoords,Ver_a_8%m(k),Ver_b_8%m(k),Cstv_pref_8,u,v,w,zd,t,tv,phis,ps,rho,q,q1,q2,q3,q4,time)
               ...
               do i = 1,l_ni
                  ...
                  call test1_advection_deformation (lon,lat,p,z,zcoords,Ver_a_8%m(k),Ver_b_8%m(k),Cstv_pref_8,utt_8,vtt_8,w,zd,t,tv,phis,ps,rho,q,q1,q2,q3,q4,time)
