...
!**s/r adv_tricub_lag3d_conserv - Same as adz_tricub_lag3d + Store Mono/Lin/Min/Max

      subroutine adv_tricub_lag3d_conserv (F_cub,F_mono,F_lin,F_min,F_max,F_in, &
...
!$omp            o1, o2, o3, o4, prf1,prf2,capx,capy,capz,&
!$omp            prmin,prmax)&
...
!$omp end parallel
      ...
      end subroutine adv_tricub_lag3d_conserv
