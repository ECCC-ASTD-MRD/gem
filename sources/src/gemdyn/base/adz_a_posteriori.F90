...
!**s/r adz_a_posteriori - Apply a posteriori Mass-fixer/Shape-Preserving schemes or Finalization

      subroutine adz_a_posteriori ( F_name_S, F_output, F_high, F_mono, F_lin, F_min, F_max, F_input, &
...
#include <arch_specific.hf>
      ...
      logical :: Bermejo_Conde_L, Clip_L, ILMC_L, BC_LAM_Aranami_L
      ...
      BC_LAM_Aranami_L= Bermejo_Conde_L.and..not.Grd_yinyang_L.and.Adz_BC_LAM_flux==1
      ...
      !Printing
      !--------
      if (Lun_verbose_L) then

         write(Lun_out,*) 'TRACERS: ----------------------------------------------------------------------'
         write(Lun_out,*) 'TRACERS: High-order SL advection: ',F_name_S(4:6)
      ...
      if (ILMC_L) call ILMC_LAM (F_name_S,F_mono,F_high,F_min,F_max,F_minx,F_maxx,F_miny,F_maxy,F_nk, &
                                 F_i0,F_in,F_j0,F_jn,F_k0,Adz_ILMC_min_max_L,Adz_ILMC_sweep_max,verbose_L)
      ...
      if (Bermejo_Conde_L) then
         ...
         call Bermejo_Conde (F_name_S,F_output,high_w,F_lin,F_min,F_max,F_input,F_for_flux_o,F_for_flux_i, &
                             ...
                             BC_LAM_Aranami_L,Adz_BC_min_max_L,verbose_L)
      ...
      end subroutine adz_a_posteriori
