...
!**s/r adz_tricub_lag3d_mono - Same as adz_tricub_lag3d but
!                              implements local monotonicity

      subroutine adz_tricub_lag3d_mono (F_cub,F_in,F_xyz,F_num,F_lev_S)
      use ISO_C_BINDING
      use glb_ld
      use ver
      use adz_mem
...
#include <arch_specific.hf>
      ...
      integer n, o1, o2, indxij
      integer :: ii1, jj1, kk1, kp1,il
      real    :: prmin, prmax
...
!
      ...
      do n=1, F_num
         ...
         if (zcubic_L) then
            ...
            o1 = kk1*Adz_nij + indxij + Adz_nit + 1
            o2 = o1 + Adz_nit
            prmax = max(F_in(o1),F_in(o1+1),F_in(o2),F_in(o2+1))
            prmin = min(F_in(o1),F_in(o1+1),F_in(o2),F_in(o2+1))
            o1 = o1 + Adz_nij
            o2 = o2 + Adz_nij
            prmax = max(prmax,F_in(o1),F_in(o1+1),F_in(o2),F_in(o2+1))
            prmin = min(prmin,F_in(o1),F_in(o1+1),F_in(o2),F_in(o2+1))
