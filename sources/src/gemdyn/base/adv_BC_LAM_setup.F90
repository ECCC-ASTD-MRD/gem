...
!**s/r adv_BC_LAM_setup - Set F_mask_o/F_mask_i for Flux calculations based on Aranami et al. (2015)

      subroutine adv_BC_LAM_setup (F_amask_o,F_amask_i,F_aminx,F_amaxx,F_aminy,F_amaxy, &
...
#include <arch_specific.hf>
      ...
      end subroutine adv_BC_LAM_setup
